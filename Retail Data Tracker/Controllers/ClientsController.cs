...
namespace Retail_Data_Tracker.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public ClientsController(Retail_Data_TrackerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Client != null ? 
                          ...
                          Problem("Entity set 'Retail_Data_TrackerContext.Client'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Address,Description")] Client client)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Retail_Data_TrackerContext.Client'  is null.");
            }
            var client = await _context.Client.FindAsync(id);
            if (client != null)
            {

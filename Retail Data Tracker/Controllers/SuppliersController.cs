...
namespace Retail_Data_Tracker.Controllers
{
    public class SuppliersController : Controller
    {
        ...
        public SuppliersController(Retail_Data_TrackerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Suppliers != null ? 
                          ...
                          Problem("Entity set 'Retail_Data_TrackerContext.Suppliers'  is null.");
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address,Description")] Supplier supplier)
        {
            if (id != supplier.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Retail_Data_TrackerContext.Suppliers'  is null.");
            }
            var supplier = await _context.Suppliers.FindAsync(id);
            if (supplier != null)
            {
